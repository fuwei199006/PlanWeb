...
namespace Tool.T4Templent.StaticPlates.Core.Handlers
{
    ...
    internal class ReverseEngineerCodeFirstHandler
    {
        ...
        public ReverseEngineerCodeFirstHandler(Tool.T4Templent.StaticPlates.Core.DbContextPackage package)
        {
        ...
        public void ReverseEngineerCodeFirst(Project project)
        {
            ...
            try
            {
                ...
                if (dialogResult != null)
                {
                    ...
                    var errors = storeGenerator.GenerateStoreMetadata(_storeMetadataFilters).Where(e => e.Severity == System.Data.Metadata.Edm.EdmSchemaErrorSeverity.Error);
                    ...
                    foreach (var entityType in entityTypes)
                    {
                        ...
                        var entityHost = new StaticTextTemplateHost()
                            {
                        ...
                        var mappingHost = new StaticTextTemplateHost
                        {
                                EntityType = entityType,
                                EntityContainer = modelGenerator.EntityContainer,
                    ...
                    var contextHost = new StaticTextTemplateHost
                    {
                            EntityContainer = modelGenerator.EntityContainer,
                            Namespace = modelsNamespace,
                            ModelsNamespace = modelsNamespace,
