...
{
    public class OptimizeContextHandler
    {
        ...
        public void OptimizeEdmx(string inputPath)
        {
            ...
            try
            {
                ...
                {
                    StorageMappingItemCollection mappingCollection = edmxUtility.GetMappingCollection();
            ...
            OptimizeContextCore(
                ...
                viewsPath =>
                {
                    var edmSchemaError = ((Type)mappingCollection.GetType()).Assembly
                        .GetType("System.Data.Metadata.Edm.EdmSchemaError", true);
