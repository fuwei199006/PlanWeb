...
namespace Tool.T4Templent.RuntimePlates.Models.Mapping
{
	public class LogMap : EntityTypeConfiguration<Log>
	{
        public LogMap()
        {
			this.Property(t => t.Thread).HasMaxLength(127);
			this.Property(t => t.Level).HasMaxLength(25);
			this.Property(t => t.Logger).HasMaxLength(127);
			this.Property(t => t.Message).HasMaxLength(2000);
			this.Property(t => t.Exception).IsRequired().HasMaxLength(1000);
